...
### ⚠️ 주요 변경사항 (v0.1.1)
- **데이터 영속성**: 서버 재시작 시 데이터가 초기화됩니다
- **메모리 사용량**: 대용량 데이터 처리 시 메모리 사용량 모니터링 필요
- **확장성**: 필요시 Redis나 다른 영속 저장소로 쉽게 교체 가능
- **의존성 감소**: MySQL, TypeORM 관련 패키지 제거로 설치 용량 감소
...
**MVP v0.1.1** - 2025년 기준 데이터베이스 제거 및 최적화 버전
